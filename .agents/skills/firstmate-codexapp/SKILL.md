...
description: >-
  ...
  Use before creating, reading, steering, archiving, debugging, or reviewing a Codex App visible thread for Firstmate work, evaluating a Codex App backend request, or reconciling Codex Desktop host-tool smoke evidence, and before responding to requests to make Codex App native to Firstmate.
