...
Run `bin/fm-questionnaire-refill-source.sh` (default 3-day freshness window): it owns only the mechanical recency check over `data/*roundtable*/report.md` and `data/*roadmap*/report.md`, never candidate judgment.
