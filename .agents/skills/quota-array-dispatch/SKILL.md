...
`AGENTS.md` section 4 owns the always-loaded intake boundary and load trigger; this skill is the single owner of the selection procedure, including the malformed-config refusal, every-candidate accounting, and strongest-reasoning/tie safety rules.
