...
# a confirmed agent-less pane is `dead` - whether nothing is registered, a
# registration lingers over a shell-only pane (stale-agent, issue #4115), or a
# registered agent's process the shutdown killed is proven gone via the pane's
# own bare idle shell (no-agent) - a
