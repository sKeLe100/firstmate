...
#                       handoff retry, X-mode artifact writes, fleet sync, upstream
#                       autosync arming with its drift poll) also run only when
#                       locked; the network sweeps run in the deferred
