...
A raw launch command does not satisfy that requirement: it is refused for routine dispatch and accepted only as one scout-only `--adapter-verification` trial.
