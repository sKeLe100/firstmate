...
| portable serial 1-4 | job `timeout-minutes: 30` | Each balanced shard is about fifteen minutes of measured script time, leaving roughly 2x hang-tripwire margin for job setup and runner-speed spread. |
